...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Developer Portfolio Joytun</title>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-6 d-none d-md-block">
                        <div class="hero-image">
                            <img src="https://i.pinimg.com/564x/7e/8a/a3/7e8aa3f2ead39c9bc1d00aa535351b63.jpg" alt="Hero Image">
                        </div>
                    </div>
                </div>
            </div>
           ...
           <div class="about wow fadeInUp" data-wow-delay="0.1s" id="about">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="https://i.pinimg.com/280x280_RS/05/ec/93/05ec93d6ef3d55d8327621d71d3a79a1.jpg" alt="Image">
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="owl-carousel testimonials-carousel">
                    <div class="testimonial-item">
                        <div class="testimonial-img">
                            <img src="https://i.pinimg.com/originals/15/0f/0f/150f0fba0af66a441d6a945c3054828a.jpg" alt="Image">
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.0s">
                        <div class="team-item">
                            <div class="team-img">
                                <img src="https://i.pinimg.com/564x/86/12/b1/8612b16e335343c10d10f2f7949fea8a.jpg" alt="Image">
                            </div>
                            <div class="team-text">
                                <h2>Shafat alom</h2>
                                <h4>Web Designer</h4>
            ...
            <div class="container-fluid">
                <div class="container">
                    <div class="footer-info">
                        <h2>Joytun Siddika Mim</h2>
                        <h3>Block :"B" Road no:22  Uposohor,Shylet </h3>
                        <div class="footer-menu">
                            <p>+8801740989976</p>
                            <p>JOYTUNSIDDIKAMIM@gmail.com</p>
                        </div>
                ...
                <div class="container copyright">
                    <p>&copy; <a href="#">joytun siddika</a>, All Right Reserved | Designed By <a href="https://htmlcodex.com">JOYTUN SIDDIKA MIM</a></p>
                </div>
            </div>
        </div>
        <!-- Footer End -->
